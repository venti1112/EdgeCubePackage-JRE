...
#   ECPKG_ID              runtime id in manifest (default: jre21)
#   ECPKG_NAME            display name (default: OpenJDK 21)
...
# ── Configuration ─────────────────────────────────────────────────────────
ECPKG_ID="${ECPKG_ID:-jre21}"
ECPKG_NAME="${ECPKG_NAME:-OpenJDK 21}"
...
ECPKG_DESCRIPTION="${ECPKG_DESCRIPTION:-OpenJDK 21 runtime for EdgeCube.}"
