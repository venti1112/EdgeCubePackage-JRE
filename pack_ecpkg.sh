...
#   ECPKG_ID              runtime id in manifest (default: jre11)
#   ECPKG_NAME            display name (default: OpenJDK 11)
...
# ── Configuration ─────────────────────────────────────────────────────────
ECPKG_ID="${ECPKG_ID:-jre11}"
ECPKG_NAME="${ECPKG_NAME:-OpenJDK 11}"
...
ECPKG_DESCRIPTION="${ECPKG_DESCRIPTION:-OpenJDK 11 runtime for EdgeCube.}"
