...
# configure defaults VERSION_OPT to "internal" and `make VERSION_OPT=` does not reliably
# override the spec.gmk value, so we patch spec.gmk directly after configure.
